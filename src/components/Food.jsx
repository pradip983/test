...
function Food({foods}) {
  return (
    <>
    <div className="w-full h-full p-6 bg-gray-50 flex flex-col gap-6 hide-scrollbar overflow-y-auto">
      {/* Title Section */}
      <div className="text-center">
        <h1 className="text-5xl font-extrabold text-gray-800">Famous Foods</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {foods.map((food, index) => (
          ...
          >
            ...
            {/* Food Info */}
            <div className="p-4 flex flex-col items-start w-full h-[37vh] justify-around">
