            ...
            <div className="  w-full  h-[40vh] p-5 ">
                    ...
                    <div className="grid grid-cols-2 gap-4 sm:gap-7 sm:grid-cols-4">
                        <div>
                            ...
                            <ul className="text-gray-900 text-xs font-normal">
                                ...
                                <li className="mb-3">
                                    <a href="" className="hover:underline">Explore India</a>
                                </li>
                                <li className="mb-3">
                        ...
                        <div>
                            ...
                            <ul className="text-gray-900  text-xs font-normal">
                                ...
                                <li className="mb-3">
                                    <a href="/AboutPage" className="hover:underline">Aboute us</a>
                                </li>
                                <li className="mb-3">
                        ...
                        <div>
                            ...
                            <ul className="text-gray-900  text-xs font-normal">
                                ...
                                <li className="mb-3">
                                    <a href="" className="hover:underline">Car</a>
                                </li>
                ...
                <div className="sm:flex sm:items-center sm:justify-between mt-1">
                    ...
                    <div className="flex mt-4 sm:justify-center sm:mt-0">
                        ...
                        <a href="#" className="text-gray-500 hover:text-gray-900 dark:hover:text-gray-800 ms-5">
