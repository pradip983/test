...
const HotelBookingTicket = ({ booking }) => {
    ...
    return (
      ...
      <div className="w-full max-w-lg p-6 shadow-lg rounded-2xl bg-white">
        <div>
          <h2 className="text-2xl font-bold text-center mb-4">Hotel Booking Ticket</h2>
          <div className="space-y-2 text-gray-700">
            <p><span className="font-semibold">Guest Name:</span> {booking.guestName}</p>
            ...
            <p><span className="font-semibold">Total Price:</span> ${booking.price}</p>
          </div>
          <div className="flex justify-between mt-6">
            <button className="flex items-center gap-2 px-4 py-2 bg-gray-200 hover:bg-gray-300 rounded-lg" onClick={() => window.print()}>
               Print Ticket
            </button>
            <button className="flex items-center gap-2 px-4 py-2 bg-blue-500 hover:bg-blue-600 text-white rounded-lg" onClick={() => alert("Email Sent!")}> 
               Email Ticket
            </button>
          </div>
        </div>
