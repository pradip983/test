    ...
    <div className="min-h-screen bg-gray-100 text-gray-800">
      ...
      <main className="max-w-screen-xl mx-auto py-12 px-6">
        ...
        <section className="mb-12">
          <h2 className="lg:text-3xl text-2xl font-bold text-sky-800">Our Mission</h2>
        ...
        <section className="mb-12">
          <h2 className="lg:text-3xl text-2xl font-bold text-sky-800">Why Choose ExploreIND?</h2>
          <ul className="mt-4 space-y-4 lg:text-lg text-base">
        ...
        {/* Our Story Section */}
        <section className="mb-12">
          <h2 className="lg:text-3xl text-2xl font-bold text-sky-800">Our Story</h2>
          <p className="mt-4 lg:text-lg text-base leading-relaxed">
        ...
        <section className="bg-[#f5f5f5] text-sky-800 py-10 rounded-lg shadow-2xl text-center">
          <h2 className="lg:text-3xl text-2xl font-bold">Start Your Journey with ExploreIND</h2>
