            ...
            <ToastContainer />
                ...
                <div className={`w-full h-[65vh] mb-5 ${visible === 'booking' ? "block" : "hidden"}`}>
                    <div className="w-[70%] h-[60vh] m-auto p-5">
                        ...
                        <h2 className="text-black text-lg font-sans">Your Recent Booking Deatils</h2>
                        <div className='border-2 m-2 border-gray-50 shadow-2xl w-full h-[45vh] rounded-2xl flex items-center justify-center'>
                            <p className='text-gray-600 text-base'>No Booking available</p>
                        </div>
                    </div>
                </div>
